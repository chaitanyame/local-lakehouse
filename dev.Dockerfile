...
# Install Hadoop AWS for S3A support
...
#COPY downloads/hadoop-aws-3.3.1.jar $SPARK_HOME/jars/hadoop-aws-3.3.1.jar
#COPY downloads/aws-java-sdk-bundle-1.11.1026.jar $SPARK_HOME/jars/aws-java-sdk-bundle-1.11.1026.jar
